        ...
        t.onmessage = function (e) {
          i.then(function () {
            switch (e.data.command) {
              case "decode":
                if (r) {
                  // Preserve Opus state, but never mix PCM from separate responses.
                  if (r.outputGeneration !== e.data.generation) r.resetOutputBuffers();
                  r.outputGeneration = e.data.generation;
                  r.decode(e.data.pages);
                }
                break;
              case "done":
            ...
            for (var r = 0, s = e.length / this.numberOfChannels; r < s; ) {
              ...
              (r += i),
                ...
                this.outputBufferIndex == this.config.bufferLength &&
                  (t.postMessage(
                    this.outputGeneration === undefined ? this.outputBuffers : { generation: this.outputGeneration, frames: this.outputBuffers },
                    this.outputBufferArrayBuffers,
                  ),
