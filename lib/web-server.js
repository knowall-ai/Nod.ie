...
const files = new Set(['index.html', 'browser-bridge.js', 'renderer.js', 'renderer.css', 'config-web.js', 'lib/config-schema.js', 'modules/audio-capture-web.js', 'modules/audio-playback-web.js', 'modules/streaming-lip-sync.js', 'modules/avatar-manager.js', 'modules/idle-avatar.js', 'modules/musetalk-websocket-client.js', 'modules/websocket-handler.js', 'modules/local-voice-session.js', 'modules/end-of-speech.js', 'modules/desktop-drag.js', 'modules/avatar-controls.js', 'assets/icons/lucide/settings.svg', 'assets/icons/lucide/mic.svg', 'assets/icons/lucide/mic-off.svg', 'assets/icons/lucide/camera-off.svg', 'assets/icons/lucide/volume-2.svg', 'assets/icons/lucide/volume-x.svg', 'audio-output-processor.js', 'decoderWorker.min.js', 'decoderWorker.min.wasm', 'encoderWorker.min.js', 'node_modules/opus-recorder/dist/recorder.min.js', 'tests/test-web.html', 'favicon.ico']);
        ...
        try {
            ...
            if (req.url.startsWith('/lip/')) {
                ...
                try {
                    ...
                    const trim=hasTrim?{startFrame:Number(req.headers['x-nodie-start-frame']),frameCount:Number(req.headers['x-nodie-frame-count'])}:undefined;
