        ...
        try {
            ...
            if (req.url.startsWith('/transcript/')) {
                ...
                try {
                    ...
                    const { epoch, turn } = JSON.parse(Buffer.concat(chunks).toString('utf8'));
