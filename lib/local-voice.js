...
class LocalVoice {
    ...
    async converse(audio) {
        ...
        try {
            ...
            const speakerObservation = await this.speakerRecognition?.analyse(audio, this.abortController.signal);
