...
class LocalVoice {
    ...
    async converse(audio) {
        ...
        try {
            ...
            stage = 'transcription';
            const speakerPending = this.speakerRecognition?.analyse(audio, this.abortController.signal);
            ...
            const speakerObservation = await speakerPending;
