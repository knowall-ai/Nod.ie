    ...
    async analyse(image, structured=false) {
        ...
        try {
            ...
            if(structured){
                ...
                return {status:'ready',subjects:[...(data.people?['Unidentified person']:[]),...new Set(subjects)]};
            }
