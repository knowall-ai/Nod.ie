(function (root) {
    ...
    const publicKeys = ['UNMUTE_BACKEND_URL', 'VOICE_MODEL', 'LLM_MODEL', 'ASSISTANT_NAME', 'GLOBAL_HOTKEY', 'AVATAR_ENABLED', 'AVATAR_IDLE_ENABLED', 'MUSETALK_HTTP', 'MUSETALK_WS', 'WEB_TEST_PORT', 'VOICE_MODE'];
