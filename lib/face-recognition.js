...
class FaceStore extends ConversationHistory {
    ...
    observe(result, epoch, signal) {
        ...
        return this.transaction(async () => {
            ...
            signal?.throwIfAborted(); await this.write(d); return { state: 'ready', faces };
        });
    }
}
...
class FaceRecognition {
    ...
    async analyse(image) {
        ...
        try {
            ...
            return await this.store.observe(await this.analyseFrame(image, controller.signal), d.epoch, controller.signal);
